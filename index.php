...
<head>
    <title>GetMi Retail On Demand</title>
    <meta charset="utf-8" />
    ...
    <div id="wrapper">
        ...
        <header id="header">
            ...
            <div class="content">
                <div class="inner">
                    <h1>GetMi</h1><br />
                    <h1>Because Time is Precious</h1>
                    <p>Connecting Communities Through Retail</p><br />
                    <p><strong>#technoLogistics</strong></p>
                </div>
            </div>
            <nav>
                <ul>
        ...
        <div id="main">
            ...
            <!-- Intro -->
            <article id="investors">
                <h2 class="major">For Investors</h2>
            ...
            <article id="retailers">
                <h2 class="major">For Retailers</h2>
                <span class="image main"><img src="images/pic02.jpg" alt="" /></span>
                <p>Get your products into customers hands in 1-hour</p>
                <!--<ul>
									<li>Get your products into customers hands in 1-hour</li>
								</ul>-->
            </article>
            ...
            <article id="riders">
                ...
                <ul class="icons">
                    <li><button onclick="window.location.href = 'https://getmi.herokuapp.com/rider/rider_login.html';">Start a New Application</button></li>
                    <li><button class="primary" onclick="window.location.href = 'https://getmi.herokuapp.com/rider/rider_reg_continue.php';">Continue an Application</button></li>
                </ul>
            </article>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
        ...
        <!-- Footer -->
        <footer id="footer">
            <p class="copyright">&copy; GetMi (2019)</p>
        </footer>
